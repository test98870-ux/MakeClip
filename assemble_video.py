...
def create_final_video():
    ...
    for folder, keyword, offset, duration in clips_config:
        ...
        if target_file.endswith('.mp4'):
            ...
            black_clip = ColorClip(size=(1280, 720), color=(0,0,0), duration=actual_duration)
    ...
    # 결과 저장
    output_path = os.path.join(result_dir, "Worship_Gathering_3min.mp4")
